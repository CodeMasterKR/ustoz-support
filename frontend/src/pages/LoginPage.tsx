...
import { Eye, EyeOff, Mail, Lock, GraduationCap, CheckCircle2, AlertCircle } from 'lucide-react'
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-14 bg-white">
        ...
        >
          ...
          {/* Heading */}
          <div className="mb-7">
            <h1 className="text-2xl font-semibold text-gray-900 mb-1.5">Kirish</h1>
            <p className="text-sm text-gray-500">Akkauntingizga xush kelibsiz</p>
          </div>
          ...
          {success && (
            <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-xl px-3 py-2.5 mb-5">
              <p className="text-sm text-emerald-600 font-semibold">Xush kelibsiz!</p>
            </div>
          )}
          ...
          <button
            type="button"
            onClick={() => !googleLoading && handleGoogleLogin()}
      ...
      >
        ...
        >
          ...
          <h2 className="text-3xl font-bold leading-snug mb-4" style={{ color: 'rgba(255,255,255,0.97)' }}>
            O'qitishni<br />osonlashtiring
          </h2>
          <p className="text-sm leading-relaxed mb-10" style={{ color: 'rgba(255,255,255,0.65)' }}>
            Sun'iy intellekt yordamida dars materiallarini tez va sifatli tayyorlang.
          </p>
